...
class SettingsPreferenceFragment : PreferenceFragmentCompat() {
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        logLevel?.let {
            it.dialogLayoutResource = R.layout.layout_loglevel_help
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.P) { // Android P is API 28
            metedNetwork?.remove()
        }
        ...
        if (profileTrafficStatistics != null && speedInterval != null) {
    ...
    private fun clearAppCache() {
        try {
            ...
            val relativeCache = parentDir?.resolve("cache")
