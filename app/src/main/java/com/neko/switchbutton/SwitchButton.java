...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (ta != null) {
            thumbDrawable = ta.getDrawable(R.styleable.SwitchButton_uwuThumbDrawable);
            thumbColor = ta.getColorStateList(R.styleable.SwitchButton_uwuThumbColor);
            margin = ta.getDimension(R.styleable.SwitchButton_uwuThumbMargin, margin);
            marginLeft = ta.getDimension(R.styleable.SwitchButton_uwuThumbMarginLeft, margin);
            marginRight = ta.getDimension(R.styleable.SwitchButton_uwuThumbMarginRight, margin);
            marginTop = ta.getDimension(R.styleable.SwitchButton_uwuThumbMarginTop, margin);
            marginBottom = ta.getDimension(R.styleable.SwitchButton_uwuThumbMarginBottom, margin);
            thumbWidth = ta.getDimension(R.styleable.SwitchButton_uwuThumbWidth, thumbWidth);
            thumbHeight = ta.getDimension(R.styleable.SwitchButton_uwuThumbHeight, thumbHeight);
            thumbRadius = ta.getDimension(R.styleable.SwitchButton_uwuThumbRadius, thumbRadius);
            backRadius = ta.getDimension(R.styleable.SwitchButton_uwuBackRadius, backRadius);
            backDrawable = ta.getDrawable(R.styleable.SwitchButton_uwuBackDrawable);
            backColor = ta.getColorStateList(R.styleable.SwitchButton_uwuBackColor);
            thumbRangeRatio = ta.getFloat(R.styleable.SwitchButton_uwuThumbRangeRatio, thumbRangeRatio);
            animationDuration = ta.getInteger(R.styleable.SwitchButton_uwuAnimationDuration, animationDuration);
            fadeBack = ta.getBoolean(R.styleable.SwitchButton_uwuFadeBack, true);
            tintColor = ta.getColor(R.styleable.SwitchButton_uwuTintColor, tintColor);
            textOn = ta.getString(R.styleable.SwitchButton_uwuTextOn);
            textOff = ta.getString(R.styleable.SwitchButton_uwuTextOff);
            textThumbInset = ta.getDimensionPixelSize(R.styleable.SwitchButton_uwuTextThumbInset, 0);
            textExtra = ta.getDimensionPixelSize(R.styleable.SwitchButton_uwuTextExtra, 0);
            textAdjust = ta.getDimensionPixelSize(R.styleable.SwitchButton_uwuTextAdjust, 0);
            ta.recycle();
        }
